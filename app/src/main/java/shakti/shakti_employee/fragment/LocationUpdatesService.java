          ...
          /*  LocalConvenienceBean localConvenienceBean;
            ...
            if (dataHelper.isRecordExist1(dataHelper.TABLE_LOCAL_CONVENIENCE, dataHelper.KEY_PERNR, userModel.uid, dataHelper.KEY_BEGDA,new CustomUtility().getCurrentDate())) {
                ...
                // Start the transaction.
                    ...
                    String Query = "SELECT * FROM " + dataHelper.TABLE_LOCAL_CONVENIENCE + " WHERE " +  dataHelper.KEY_PERNR +  " = '" +  userModel.uid + "'" + " AND " +  dataHelper.KEY_BEGDA +  " = '" +  new CustomUtility().getCurrentDate() + "'";
                ...
                Log.i(TAG, "New location: " + location);
                 ...
                 localConvenienceBean = new LocalConvenienceBean(userModel.uid,
                        date,
                        "",
                        time,
                        "",
