...
import shakti.shakti_employee.fragment.AttendanceCreateFragment;
...
public class AttendanceActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setUpNavigationView();
        dataHelper = new DatabaseHelper(AttendanceActivity.this);


        getSupportActionBar().setTitle("Mark Attendance");


        Fragment fragment = new AttendanceCreateFragment();
