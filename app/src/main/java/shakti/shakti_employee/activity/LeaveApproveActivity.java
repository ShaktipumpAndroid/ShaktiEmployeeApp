...
import shakti.shakti_employee.fragment.LeaveApproveFragment;
...
public class LeaveApproveActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Fragment fragment = new LeaveApproveFragment();
...
//                        Toast.makeText(LeaveApproveActivity.this,"Leave Request Activity", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(LeaveApproveActivity.this, DashboardActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_logout) {
            if (CustomUtility.isInternetOn(mContext)) {
                ...
                dataHelper = new DatabaseHelper(LeaveApproveActivity.this);
                ...
                // Goto Login Activity
                Intent intent = new Intent(LeaveApproveActivity.this, LoginActivity.class);
                startActivity(intent);
                this.finish();
                return true;
            } else {
                Toast.makeText(LeaveApproveActivity.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
            }
            return true;
        }
