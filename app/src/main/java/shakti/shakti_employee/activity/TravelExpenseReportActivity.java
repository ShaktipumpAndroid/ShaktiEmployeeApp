...
import shakti.shakti_employee.fragment.TravelExpenseReportFragment;
import shakti.shakti_employee.model.LoggedInUser;
import shakti.shakti_employee.other.CustomUtility;

public class TravelExpenseReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*  if (!isDownloadServiceRunning()) {
            ...
            startService(new Intent(TravelExpenseReportActivity.this, TimeServiceDownloadData.class));

        }*/

        /* getSupportActionBar().setTitle("Expenses Report");*/


        Fragment fragment = new TravelExpenseReportFragment();
...
//                        Toast.makeText(OdApproveActivity.this,"Leave Request Activity", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(TravelExpenseReportActivity.this, DashboardActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_logout) {
            if (CustomUtility.isInternetOn(mContext)) {
                ...
                dataHelper = new DatabaseHelper(TravelExpenseReportActivity.this);
                ...
                // Goto Login Activity
                Intent intent = new Intent(TravelExpenseReportActivity.this, LoginActivity.class);
                startActivity(intent);
                this.finish();
                return true;
            } else {
                Toast.makeText(TravelExpenseReportActivity.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
            }
            return true;
        }
