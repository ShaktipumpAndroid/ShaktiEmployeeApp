...
import shakti.shakti_employee.fragment.OdApproveFragment;
import shakti.shakti_employee.fragment.OfficialDutyFragment;
import shakti.shakti_employee.model.LoggedInUser;
import shakti.shakti_employee.other.CustomUtility;

public class OdApproveActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("OD Approve");


        Fragment fragment = new OdApproveFragment();
...
//                        Toast.makeText(OdApproveActivity.this,"Leave Request Activity", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(OdApproveActivity.this, DashboardActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_logout) {
            if (CustomUtility.isInternetOn(mContext)) {
                ...
                dataHelper = new DatabaseHelper(OdApproveActivity.this);
                ...
                // Goto Login Activity
                Intent intent = new Intent(OdApproveActivity.this, LoginActivity.class);
                startActivity(intent);
                this.finish();
                return true;
            } else {
                Toast.makeText(OdApproveActivity.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
            }
            return true;
        }
