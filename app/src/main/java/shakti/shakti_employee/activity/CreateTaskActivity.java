...
import shakti.shakti_employee.fragment.CreateTaskFragment;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_logout) {
            if (CustomUtility.isInternetOn(mContext)) {
                ...
                dataHelper = new DatabaseHelper(CreateTaskActivity.this);
                ...
                Toast.makeText(CreateTaskActivity.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
            }
            return true;
        }
