...
import shakti.shakti_employee.fragment.DomesticTravelExpFragment;
...
public class DomesticTravelExpensesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* if (!isDownloadServiceRunning()) {
            ...
            startService(new Intent(DomesticTravelExpensesActivity.this, TimeServiceDownloadData.class));

        }*/

        getSupportActionBar().setTitle("Domestic Travel Expenses");


        Fragment fragment = new DomesticTravelExpFragment();
...
//                        Toast.makeText(OdApproveActivity.this,"Leave Request Activity", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(DomesticTravelExpensesActivity.this, DashboardActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_logout) {
            if (CustomUtility.isInternetOn(mContext)) {
                ...
                dataHelper = new DatabaseHelper(DomesticTravelExpensesActivity.this);
                ...
                // Goto Login Activity
                Intent intent = new Intent(DomesticTravelExpensesActivity.this, LoginActivity.class);
                startActivity(intent);
                this.finish();
                return true;
            } else {
                Toast.makeText(DomesticTravelExpensesActivity.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
            }
            return true;
        }
