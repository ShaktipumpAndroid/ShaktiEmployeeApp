...
public class CompleteTaskActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setUpNavigationView();
        dataHelper = new DatabaseHelper(CompleteTaskActivity.this);

//        if (!isDownloadServiceRunning()) {
//            //Toast.makeText(DashboardActivity.this, "Download Data", Toast.LENGTH_SHORT).show();
//            startService(new Intent(CompleteTaskActivity.this, TimeServiceDownloadData.class));
//
//        }

        getSupportActionBar().setTitle("Pending Tasks" + "(" + dataHelper.getPendinTaskCount() + ")");


        Fragment fragment = new CompleteTaskFragment();
...
//                        Toast.makeText(OdApproveActivity.this,"Leave Request Activity", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(CompleteTaskActivity.this, DashboardActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_logout) {
            if (CustomUtility.isInternetOn(mContext)) {
                ...
                Toast.makeText(CompleteTaskActivity.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
            }
            return true;
        }
