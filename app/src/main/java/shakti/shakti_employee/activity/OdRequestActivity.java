...
import shakti.shakti_employee.fragment.ODRequestFragment;
import shakti.shakti_employee.fragment.OfficialDutyFragment;
import shakti.shakti_employee.model.LoggedInUser;
import shakti.shakti_employee.other.CustomUtility;

public class OdRequestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("OD Request");


        Fragment fragment = new ODRequestFragment();
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.nav_home:
//                        Toast.makeText(OdRequestActivity.this,"Leave Request Activity", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(OdRequestActivity.this, DashboardActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_logout) {
            if (CustomUtility.isInternetOn(mContext)) {
                ...
                dataHelper = new DatabaseHelper(OdRequestActivity.this);
                ...
                // Goto Login Activity
                Intent intent = new Intent(OdRequestActivity.this, LoginActivity.class);
                startActivity(intent);
                this.finish();
                return true;
            } else {
                Toast.makeText(OdRequestActivity.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
            }
            return true;
        }
