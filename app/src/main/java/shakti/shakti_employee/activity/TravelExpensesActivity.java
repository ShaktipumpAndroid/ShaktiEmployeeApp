...
import shakti.shakti_employee.fragment.TravelExpFragment;
import shakti.shakti_employee.model.LoggedInUser;
import shakti.shakti_employee.other.CustomUtility;

public class TravelExpensesActivity extends BaseActivity {
    ...
    public static String CURRENT_TAG = TAG_HOME, count;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* if (!isDownloadServiceRunning()) {
            ...
            startService(new Intent(TravelExpensesActivity.this, TimeServiceDownloadData.class));

        }
*/
        getSupportActionBar().setTitle("Travel Expenses Entry");


        Fragment fragment = new TravelExpFragment();
...
//                        Toast.makeText(OdApproveActivity.this,"Leave Request Activity", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(TravelExpensesActivity.this, DashboardActivity.class);
...
//                loadHomeFragment();
    ...
    public void onBackPressed() {
       ...
       /* Intent intent = new Intent(TravelExpensesActivity.this, DomesticTravelExpensesActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_logout) {
            if (CustomUtility.isInternetOn(mContext)) {
                ...
                dataHelper = new DatabaseHelper(TravelExpensesActivity.this);
                ...
                // Goto Login Activity
                Intent intent = new Intent(TravelExpensesActivity.this, LoginActivity.class);
                startActivity(intent);
                this.finish();
                return true;
            } else {
                Toast.makeText(TravelExpensesActivity.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
            }
            return true;
        }
