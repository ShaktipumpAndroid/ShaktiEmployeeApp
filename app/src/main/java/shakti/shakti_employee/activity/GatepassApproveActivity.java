...
import shakti.shakti_employee.fragment.GatepassApproveFragment;
...
public class GatepassApproveActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Gatepass Approval");


        Fragment fragment = new GatepassApproveFragment();
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.nav_home:
//                        Toast.makeText(LeaveApproveActivity.this,"Leave Request Activity", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(GatepassApproveActivity.this, DashboardActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_logout) {
            if (CustomUtility.isInternetOn(mContext)) {
                ...
                dataHelper = new DatabaseHelper(GatepassApproveActivity.this);
                ...
                // Goto Login Activity
                Intent intent = new Intent(GatepassApproveActivity.this, LoginActivity.class);
                startActivity(intent);
                this.finish();
                return true;
            } else {
                Toast.makeText(GatepassApproveActivity.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
            }
            return true;
        }
