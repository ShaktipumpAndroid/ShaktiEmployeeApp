...
import shakti.shakti_employee.fragment.GPRequestFragment;
...
public class GpRequestActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Gatepass Request");


        Fragment fragment = new GPRequestFragment();
...
//                        Toast.makeText(OdRequestActivity.this,"Leave Request Activity", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(GpRequestActivity.this, DashboardActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_logout) {
            if (CustomUtility.isInternetOn(mContext)) {
                ...
                dataHelper = new DatabaseHelper(GpRequestActivity.this);
                ...
                // Goto Login Activity
                Intent intent = new Intent(GpRequestActivity.this, LoginActivity.class);
                startActivity(intent);
                this.finish();
                return true;
            } else {
                Toast.makeText(GpRequestActivity.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
            }
            return true;
        }
