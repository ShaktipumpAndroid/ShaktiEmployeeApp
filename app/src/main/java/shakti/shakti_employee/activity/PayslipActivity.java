...
public class PayslipActivity extends AppCompatActivity {
    ...
    WebView browser;
    int index;
    String st_payslip_year, st_payslip_month;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        payslip_download.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(PayslipActivity.this, "You request for payslip download", Toast.LENGTH_LONG).show();
                callWebPage();
                forgotpwd();
...
//        String [] year = { "Select Year", "2018", "2017", "2016", "2015", "2014"};
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                ...
                st_payslip_year = finalSpinner.getSelectedItem().toString();
        ...
        spinner1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                index = arg0.getSelectedItemPosition();
                st_payslip_month = finalSpinner1.getSelectedItem().toString();
                // Toast.makeText(DsrEntryActivity.this, String.valueOf(index), Toast.LENGTH_LONG).show();
            }
...
//        // browser.loadUrl("https://www.google.co.in/");
    ...
    private void forgotpwd() {
        ...
        browser.loadUrl(SapUrl.payslip + "?id=" + userModel.uid + "&=yr" + st_payslip_year + "&=mo" + st_payslip_month);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(PayslipActivity.this, DashboardActivity.class);
