...
import shakti.shakti_employee.fragment.TravelTripDomExpFragment;
import shakti.shakti_employee.fragment.TravelTripExpExpFragment;
...
public class TravelTripExpensesActivity extends BaseActivity {
    ...
    public static String CURRENT_TAG = TAG_HOME, coun, tax, loc, loc_txt, sta, end, reinr, from;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sta = bundle.getString("start");
        end = bundle.getString("end");
        loc = bundle.getString("loc");
        coun = bundle.getString("coun");
        reinr = bundle.getString("reinr");
        from = bundle.getString("from");
        loc_txt = bundle.getString("loc_txt");
      ...
      /*  if (!isDownloadServiceRunning()) {
            ...
            startService(new Intent(TravelTripExpensesActivity.this, TimeServiceDownloadData.class));

        }*/

        getSupportActionBar().setTitle("Travel Trip Expenses");

        if (coun.equalsIgnoreCase("IN")) {
            Fragment fragment = new TravelTripDomExpFragment();
            ...
            Fragment fragment = new TravelTripExpExpFragment();
            FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
            fragmentTransaction.setCustomAnimations(android.R.anim.fade_in, android.R.anim.fade_out);
            fragmentTransaction.replace(R.id.frame, fragment, CURRENT_TAG);
            fragmentTransaction.commitAllowingStateLoss();
...
//                        Toast.makeText(OdApproveActivity.this,"Leave Request Activity", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(TravelTripExpensesActivity.this, DashboardActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_logout) {
            if (CustomUtility.isInternetOn(mContext)) {
                ...
                dataHelper = new DatabaseHelper(TravelTripExpensesActivity.this);
                ...
                // Goto Login Activity
                Intent intent = new Intent(TravelTripExpensesActivity.this, LoginActivity.class);
                startActivity(intent);
                this.finish();
                return true;
            } else {
                Toast.makeText(TravelTripExpensesActivity.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
            }
            return true;
        }
