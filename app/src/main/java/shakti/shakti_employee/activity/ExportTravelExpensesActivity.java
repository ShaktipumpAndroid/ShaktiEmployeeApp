...
import shakti.shakti_employee.fragment.ExportTravelExpFragment;
...
public class ExportTravelExpensesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* if (!isDownloadServiceRunning()) {
            ...
            startService(new Intent(ExportTravelExpensesActivity.this, TimeServiceDownloadData.class));

        }*/

        getSupportActionBar().setTitle("Export Travel Expenses");


        Fragment fragment = new ExportTravelExpFragment();
...
//                        Toast.makeText(OdApproveActivity.this,"Leave Request Activity", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(ExportTravelExpensesActivity.this, DashboardActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_logout) {
            if (CustomUtility.isInternetOn(mContext)) {
                ...
                dataHelper = new DatabaseHelper(ExportTravelExpensesActivity.this);
                ...
                // Goto Login Activity
                Intent intent = new Intent(ExportTravelExpensesActivity.this, LoginActivity.class);
                startActivity(intent);
                this.finish();
                return true;
            } else {
                Toast.makeText(ExportTravelExpensesActivity.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
            }
            return true;
        }
